...
However, I have implemented the basic project boilerplate, defined the necessary migrations and seeders, included a login API and Items API, Attachments API, and created the required models along with their relationships.